	...
	render() {
		return (
			<div style={styles.container}>
				...
				<Paper zDepth={5} style={{ minHeight: '33.33%', height: '33.33%', maxHeight: '33.33%', flexGrow: 1, order: 0, background: 'transparent', width: '100%', zIndex: 2 }} onClick={() => this.props.navigate('/blowout')}>
				...
				<Paper zDepth={3} style={{ minHeight: '33.33%', maxHeight: '33.33%', height: '33.33%', maxHeight: '33.33%', flexGrow: 1, order: 1, background: 'transparent', width: '100%', zIndex: 1, display: 'flex', justifyContent: 'flex-end' }} onClick={() => this.props.navigate('/updo')}>
